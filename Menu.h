...
public:
	...
	CSlider CustomPitch;
	CCheckBox LBY;
	CCheckBox EnabledManualAA;
	CSeperate FakeYaw1;
	CComboBox FakeYaw;
	CCheckBox LowerbodyFix;
	CCheckBox LBYNOTHING;
	...
	CSeperate AntiAimLBY1;
	CSeperate AimbotManualAA1;
	CKeyBind AimbotManualAA;
	CComboBox AntiAimLBY;
	CComboBox AntiAimEdge;
	CSlider AntiAimOffset;
	CSlider LBYBreakDelta;
...
public:
	...
	CComboBox FakeAngles;
	CSeperate FakeAngles1;
	...
	CComboBox ChamsScende;
	CSeperate OtherNoHands1;
	CSeperate ChamsScende1;
...
public:
	...
	CSeperate StatTrackAmount1;
	CTextField StatTrackAmount;
	CSeperate SkinName1;
	CTextField SkinName;
	CSeperate KnifeName1;
